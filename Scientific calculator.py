...
btnDot=Button(calc,text=".",width= 6,height=2,font=('arial',20,'bold'),bd=4,
                ...
                bg="powder blue",command=lambda: added_value.numberEnter(".")).grid(row=5,column=2,pady=1)
btnPM=Button(calc,text=chr(177),width= 6,height=2,font=('arial',20,'bold'),bd=4,

                bg="powder blue",command=added_value.mathsPM).grid(row=5,column=1,pady=1)
...
btn2pi=Button(calc,text="2π",width= 6,height=2,font=('arial',20,'bold'),bd=4,
                ...
                bg="powder blue",command=added_value.tau
...
btnnlog=Button(calc,text="log",width= 6,height=2,font=('arial',20,'bold'),bd=4,
...
btnexpm1=Button(calc,text="expm1",width= 6,height=2,font=('arial',20,'bold'),bd=4,
                ...
                bg="powder blue",command=added_value.expml).grid(row=5,column=6,pady=1)
btnlgama=Button(calc,text="lgama",width= 6,height=2,font=('arial',20,'bold'),bd=4,
...
#=====================================================================#
def iExit():
    iExit=tkinter.messagebox.askyesno("scientific Calcualtor","confirm if you want to exit")
    if iExit>0:
        root.destroy()
        return
def scientific():
...
helpmenu.add_command(label="viewhelp")
